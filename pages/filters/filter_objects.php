           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="row margin">
                        <div class="col-md-3">
                            <a href="#" class="btn btn-block btn-success btn-sm" onclick="open_modal(0, 'objects', 'edit');">
                                <i class="fa fa-fw fa-plus"></i> Продавец
                            </a>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" name="pay_type" value="1">
                            <label>Вторичное</label>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" name="pay_type" value="2">
                            <label>Новостройки с ключами</label>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" name="pay_type" value="0">
